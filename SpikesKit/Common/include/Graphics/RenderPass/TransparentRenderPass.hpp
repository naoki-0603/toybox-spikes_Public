...
#ifndef SPIKES_KIT_COMMON_GRAPHICS_RENDER_PASS_TRANSPARENT_RENDER_PASS_HPP_
#define SPIKES_KIT_COMMON_GRAPHICS_RENDER_PASS_TRANSPARENT_RENDER_PASS_HPP_
...
namespace ts
{
	namespace kit
	{
		namespace graphics
		{
			struct TransparentRenderPassData final
			{
			...
			public:
				...
				TransparentRenderPass(TransparentRenderPass&&) noexcept = default;
				~TransparentRenderPass() noexcept = default;
			public:
				[[nodiscard]]
				bool Create(
			...
			private:
				std::vector<TransparentRenderPassData> m_data;
...
#endif //! SPIKES_KIT_COMMON_GRAPHICS_RENDER_PASS_TRANSPARENT_RENDER_PASS_HPP_